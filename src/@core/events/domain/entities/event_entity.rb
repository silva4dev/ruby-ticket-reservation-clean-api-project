  ...
  module Domain
    module Entities
      class Event < Common::Domain::AggregateRoot
        attr_accessor :name, :description, :date, :is_published, :total_spots, :total_spots_reserved, :partner_id

        def initialize(id: nil, name:, description:, date:, is_published:, total_spots:, total_spots_reserved:, partner_id:)
          super()
